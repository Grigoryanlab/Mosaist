...
all:
	mkdir -p objs; cd objs; g++ $(CPPFLAGS) -I../include -c ../src/mstlinalg.cpp ../src/mstoptions.cpp ../src/msttypes.cpp ../src/msttransforms.cpp ../src/mstrotlib.cpp ../src/mstmagic.cpp ../src/mstcondeg.cpp
