...
BOOST_PYTHON_MODULE(mstpython) {
    ...
    .def("previousResidue", &MST::Residue::previousResidue, return_value_policy<manage_new_object>())
    .def("nextResidue", &MST::Residue::nextResidue, return_value_policy<manage_new_object>())
