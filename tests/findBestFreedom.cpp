...
int main(int argc, char *argv[]) {
  real lcpMin = 0.1;       // the lowest low collision probability (CP) cutoff value to consider
  real lcpMax = 0.9;       // the highest low CP cutoff value to consider
  real hcpMin = 1.0;       // the lowest high CP cutoff value to consider
